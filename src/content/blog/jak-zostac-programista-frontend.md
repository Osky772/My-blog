...
Więcej o Git i GitHub napiszę w przyszłych wpisach.
...
![Wikipedia z CSS](/images/jak-zostac-programista-frontend/wikipedia-z-css.webp)

a tak wygląda ta sama strona Wikipedii, ale już bez CSS:

![Wikipedia bez CSS](/images/jak-zostac-programista-frontend/wikipedia-bez-css.webp)
...
Polecam zatem kursy na YT do nauki HTML i CSS, a przy okazji oficjalną dokumentację tych obu języków, czyli [MDN](https://developer.mozilla.org/pl/docs/Web). 

### Uwaga!
Wybrałem materiały na których sam się uczyłem aleee są one troche przestarzałe, szczególnie te od Pasjai Informatyki. Jednak osobiście nauczyłem się na tych materiałach bardzo dużo, i pomimo, że już nie piszę takiego kodu jaki tam jest, to bardzo szanuję prezentowany na tym kanale sposób i podejście nauki do programowania dla początkujących.

Materiały do nauki HTML:
- Kurs HTML od Pasja Informatyki - .
- Kurs CSS od Pasja Informatyki - .
- Traversy Media, projekt tworzenia responsywnej strony (w sam raz do portfolio) - .
...
Dobre praktyki w CSS to świadome używanie id oraz klas, grupowanie styli, znajomość specificity, BEM. Polecam przeczytać [ten artykuł](https://code.tutsplus.com/tutorials/30-css-best-practices-for-beginners--net-6741) o dobrych praktykach w CSS.

## Flexbox, Grid

Flexbox to stosunkowo nowa technologia, która bardzo ułatwia tworzenie elastycznego layoutu strony. Elementy układa się wzdłuż osi pionowej lub poziomej, dzięki czemu łatwo i szybko możemy wyśrodkować elementy, wyrównać je do prawej, do dołu, itp. Flexbox ma już [duże wsparcie](https://caniuse.com/#feat=flexbox) w przeglądarkach, więc na ogół można śmiało go używać. Osobiście używam flexboxa zawsze, gdy pojawia się jakakolwiek potrzeba pozycjononowania elementu na stronie. 
...
- Traversy Media - .
- Drew Ryan -  (dla chętnych projekt strony internetowej opartej na Bootstrapie).
...
Znajomość Javascriptu to po prostu must-have.
...
Warto znać pojęcie testów jednostkowych, integracyjnych i E2E. Polecam zaznajomić się trochę z jakąś popularną biblioteką do testowania, np. [Jest](https://jestjs.io/) lub [Jasmine](https://jasmine.github.io/). W pracy korzystamy również z Cypress, biblioteką do testów E2E. Testowanie aplikacji jest ważne. Testowanie daje nam pewność, o ile dobrze napiszemy testy, że wprowadzone nowe zmiany do kodu, nie popsują działających funkcjonalności.

Polecam poniższe materiały do zaznajomienia się z testowaniem:
- Acedemind, o testach jednostkowych, integracyjnych i E2E - .
- Fun Fun Function, o testach jednostkowych - .
- Traversy Media, o testach jednostkowych w JEST - .
...
Moim zdaniem, na początek wystarczy wiedza ogólna o Webpacku. Narzędzie jest zbyt rozbudowane dla początkującego programisty, i nie ma sensu tracic czasu na zaawansowane bundlowanie aplikacji. Poza tym instnieje kilka innych rozwiązań na rynku, między innymi [Parcel](https://parceljs.org/), który jest znacznie prostszy w obsłudze 👶. Za pomocą Parcela łatwo zbudujemy aplikację pisaną w React'cie. 
...
Film na YT od Codeevolution o Typescript - .
...
1. Własna strona internetowa portfolio.  
Ten projekt polecam zrobić po opanowaniu HTML'a i CSS'a. Swoją stronę polecam zbudować tylko przy pomocy tych technologii. Moim zdaniem nie ma sensu uczyć się preprocesora CSS ani tym bardziej Bootstrapa i przy ich pomocy zrobić własne portfolio, bo po pierwsze - szkoda czasu, a po drugie - trzeba opanować podstawy. Lepiej dobrze opanować podstawowe technologie, które nigdy nie wyjdą z mody. Fascynujące jest szukanie inspiracji. Nie spiesz się z tym. Poszukaj dokładnie w internecie i zbierz pomysły. Warto wzorować się na kimś, szczególnie, gdy na początku ma się małą wiedzę i umiejętności. Projekt mojej strony portfolio, został prawie w całości przekopiowany (design nie jest łatwy). Mimo wszystko i tak napisałem całą stronę od 0, dzięki czemu bardzo dużo się nauczyłem. Swoją gotową stronę internetową możesz wrzucić na Githuba, który oferuje darmowy hosting. Tak zrobiłem ze swoją stroną portfolio - .

2. Strona internetowa z użyciem Flexbox'a i/lub Grid'a.  
Ogólnie to twoja strona portfolio powinna używać Flexbox'a ale to ma być dodatkowy projekt i warto spróbować z Grid'em. Warto zrobić ładną stronkę z użyciem Flexbox'a i/lub Grid'a. Możesz wejść sobie na stronę  lub  wybrać coś, co Ci się spodoba i napisać taką stronę.

3. Projekt w czystym JS.  
Jak już ogarniesz trochę JS'a, łapanie elementów na stronie, pętle, kilka metod z przeglądarkowego API, to aby opanować te podstawowe umiejętności, trzeba napisać swój projekt. Przykładowe pomysły na aplikacje: zegar, kalkulator, gra (najbardziej ambitne i rozwijające), to-do lista, quiz. Osobiście napisałem grę, i na tej grze nauczyłem się programowania - .

4. Projekt z użyciem React'a.  
Aplikacja napisana w Reacie to kolejny must-have w twoim portfolio. Warto od razu napisać apkę z użyciem Reduxa, ale nie jest to konieczne (jak wcześniej wspomniałem, Redux Ci pomoże, jeśli twoja aplikacja będzie zawierała podstrony, wyskakujące okienka itd.). Warto też użyć bazy danych Firebase. Tutaj najlepiej dać ponieść się wyboraźni. Ja napisałem aplikację elektroniczny śpiewnik (), bo czegoś takiego potrzebowałem dla samego siebie. Połączyłem przyjemne z pożytecznym 🥳. Możesz też pomyśleć, o jakiejś aplikacji, którą sam chciałbyś używać. Jeśli nie wymyślisz nic kreatywanego, to wpisz sobie w Google, lub na YT: react projects, react projects firebase. 
...
Jeśli masz jakiekolwiek pytania, chcesz o coś zapytać, potrzebujesz pomocy w czymkolwiek to pisz w komentarzu. Chętnie pomogę 🙂. Życzę powodzenia i widzimy się w następnych wpisach ✋!
