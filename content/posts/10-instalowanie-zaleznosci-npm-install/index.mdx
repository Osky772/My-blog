...
- <ExternalPostLink url={"https://www.geeksforgeeks.org/what-is-the-meaning-of-save-for-npm-install/"} name={"https://www.geeksforgeeks.org/what-is-the-meaning-of-save-for-npm-install/"} />
- <ExternalPostLink url={"https://docs.npmjs.com/cli/v7/commands/npm-install"} name={"https://docs.npmjs.com/cli/v7/commands/npm-install"} />
