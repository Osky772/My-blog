...
import Image from '../../../src/components/Gif.tsx';

W poprzednim [wpisie](https://www.oskarkowalow.pl/jak-zostalem-programista) opowiedziałem moją historię związaną z wyborem zawodu programisty. Teraz chcę Ci przedstawić, jak wygląda droga edukacji do zostania front-end developerem.
...
- Kurs HTML od Pasja Informatyki - https://www.youtube.com/playlist?list=PLOYHgt8dIdox9Qq3X9iAdSVekS_5Vcp5r.
- Kurs CSS od Pasja Informatyki - https://www.youtube.com/playlist?list=PLOYHgt8dIdow6b2Qm3aTJbKT2BPo5iybv.
- Traversy Media, projekt tworzenia responsywnej strony (w sam raz do portfolio) - https://www.youtube.com/watch?v=Wm6CUkswsNw.
...
Materiały o RWD:
- Wikipedia - https://pl.wikipedia.org/wiki/Responsive_web_design.
- The Net Ninja - https://www.youtube.com/watch?v=5xzaGSYd7jM.
...
- FreeCodeCamp - https://www.youtube.com/watch?v=-Wlt8NRtOpo.
- The Net Ninja - https://www.youtube.com/playlist?list=PL4cUxeGkcC9i3FXJSUfmsNOx8E7u6UuhG.

Materiały do nauki CSS Grid:
- CSS Tricks - https://css-tricks.com/snippets/css/complete-guide-grid/.
- Traversy Media - https://www.youtube.com/watch?v=jV8B24rSN5o.
- The Net Ninja - https://www.youtube.com/playlist?list=PL4cUxeGkcC9itC4TxYMzFCfveyutyPOCY.
...
- Traversy Media - https://www.youtube.com/watch?v=5GcQtLDGXy8.
- Drew Ryan - https://www.youtube.com/watch?v=9cKsq14Kfsw (dla chętnych projekt strony internetowej opartej na Bootstrapie).
- Oficjalna dokumentacja - https://getbootstrap.com/docs/4.5/getting-started/introduction/.
...
- Filmik od Overment https://youtu.be/P9b8-BrWdYs.
...
- Acedemind, o testach jednostkowych, integracyjnych i E2E - https://youtu.be/r9HdJ8P6GQI,
- Fun Fun Function, o testach jednostkowych - https://youtu.be/Eu35xM76kKY,
- Traversy Media, o testach jednostkowych w JEST - https://youtu.be/7r4xVDI2vho
...
- DesignCourse - https://youtu.be/TzdEpgONurw,
- Traversy Media - https://youtu.be/lziuNMk_8eQ.
