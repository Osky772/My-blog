...
W poprzednim <TLink href="/blog/jak-zostalem-programista">wpisie</TLink> opowiedziałem moją historię związaną z wyborem zawodu programisty. Teraz chcę Ci przedstawić, jak wygląda droga edukacji do zostania front-end developerem.
...
<Image src="./wikipedia-z-css.webp"/>

a tak wygląda ta sama strona Wikipedii, ale już bez CSS:
<Image src="./wikipedia-bez-css.webp"/>
...
Polecam zatem kursy na YT do nauki HTML i CSS, a przy okazji oficjalną dokumentację tych obu języków, czyli <ExternalPostLink name="MDN" url="https://developer.mozilla.org/pl/docs/Web"/>. 
...
- Kurs HTML od Pasja Informatyki - <ExternalPostLink url="https://www.youtube.com/playlist?list=PLOYHgt8dIdox9Qq3X9iAdSVekS_5Vcp5r"/>.
- Kurs CSS od Pasja Informatyki - <ExternalPostLink url="https://www.youtube.com/playlist?list=PLOYHgt8dIdow6b2Qm3aTJbKT2BPo5iybv"/>.
- Traversy Media, projekt tworzenia responsywnej strony (w sam raz do portfolio) - <ExternalPostLink url="https://www.youtube.com/watch?v=Wm6CUkswsNw"/>.
...
Materiały o RWD:
- Wikipedia - <ExternalPostLink url="https://pl.wikipedia.org/wiki/Responsive_web_design"/>.
- The Net Ninja - <ExternalPostLink url="https://www.youtube.com/watch?v=5xzaGSYd7jM"/>.

### Dobre praktyki pisania CSS  

Dobre praktyki w CSS to świadome używanie id oraz klas, grupowanie styli, znajomość specificity, BEM. Polecam przeczytać <ExternalPostLink name="ten artykuł" url="https://code.tutsplus.com/tutorials/30-css-best-practices-for-beginners--net-6741"/> o dobrych praktykach w CSS.

### Flexbox, Grid

Flexbox to stosunkowo nowa technologia, która bardzo ułatwia tworzenie elastycznego layoutu strony. Elementy układa się wzdłuż osi pionowej lub poziomej, dzięki czemu łatwo i szybko możemy wyśrodkować elementy, wyrównać je do prawej, do dołu, itp. Flexbox ma już <ExternalPostLink name="duże wsparcie" url="https://caniuse.com/#feat=flexbox"/> w przeglądarkach, więc na ogół można śmiało go używać. Osobiście używam flexboxa zawsze, gdy pojawia się jakakolwiek potrzeba pozycjononowania elementu na stronie. 
...
- CSS Tricks - <ExternalPostLink url="https://css-tricks.com/snippets/css/a-guide-to-flexbox/"/>.
- FreeCodeCamp - <ExternalPostLink url="https://www.youtube.com/watch?v=-Wlt8NRtOpo"/>.
- The Net Ninja - <ExternalPostLink url="https://www.youtube.com/playlist?list=PL4cUxeGkcC9i3FXJSUfmsNOx8E7u6UuhG"/>.

Materiały do nauki CSS Grid:
- CSS Tricks - <ExternalPostLink url="https://css-tricks.com/snippets/css/complete-guide-grid/"/>.
- Traversy Media - <ExternalPostLink url="https://www.youtube.com/watch?v=jV8B24rSN5o"/>.
- The Net Ninja - <ExternalPostLink url="https://www.youtube.com/playlist?list=PL4cUxeGkcC9itC4TxYMzFCfveyutyPOCY"/>.

A tutaj film od Traversy Media, gdzie tworzą stronę internetową z RWD, używając Flexboxa i CSS Grid (pyk, projekt do portfolio!): <ExternalPostLink url="https://www.youtube.com/watch?v=moBhzSC455o"/>.
...
- Traversy Media - <ExternalPostLink url="https://www.youtube.com/watch?v=5GcQtLDGXy8"/>.
- Drew Ryan - <ExternalPostLink url="https://www.youtube.com/watch?v=9cKsq14Kfsw"/> (dla chętnych projekt strony internetowej opartej na Bootstrapie).
- Oficjalna dokumentacja - <ExternalPostLink url="https://getbootstrap.com/docs/4.5/getting-started/introduction/"/>.
...
Więcej o REST API:
- <ExternalPostLink url="https://devszczepaniak.pl/wstep-do-rest-api/"/>.
- Filmik od Overment <ExternalPostLink url="https://youtu.be/P9b8-BrWdYs"/>.

### Testy

Warto znać pojęcie testów jednostkowych, integracyjnych i E2E. Polecam zaznajomić się trochę z jakąś popularną biblioteką do testowania, np. <ExternalPostLink name="Jest" url="https://jestjs.io/"/> lub [Jasmine](https://jasmine.github.io/). W pracy korzystamy również z Cypress, biblioteką do testów E2E. Testowanie aplikacji jest ważne. Testowanie daje nam pewność, o ile dobrze napiszemy testy, że wprowadzone nowe zmiany do kodu, nie popsują działających funkcjonalności.

Polecam poniższe materiały do zaznajomienia się z testowaniem:
- Acedemind, o testach jednostkowych, integracyjnych i E2E - <ExternalPostLink url="https://youtu.be/r9HdJ8P6GQI"/>.
- Fun Fun Function, o testach jednostkowych - <ExternalPostLink url="https://youtu.be/Eu35xM76kKY"/>.
- Traversy Media, o testach jednostkowych w JEST - <ExternalPostLink url="https://youtu.be/7r4xVDI2vho"/>.
...
Moim zdaniem, na początek wystarczy wiedza ogólna o Webpacku. Narzędzie jest zbyt rozbudowane dla początkującego programisty, i nie ma sensu tracic czasu na zaawansowane bundlowanie aplikacji. Poza tym instnieje kilka innych rozwiązań na rynku, między innymi <ExternalPostLink name="Parcel" url="https://parceljs.org/"/>, który jest znacznie prostszy w obsłudze 👶. Za pomocą Parcela łatwo zbudujemy aplikację pisaną w React'cie. 

Polecam poniższe materiały o Webpacku:
- DesignCourse - <ExternalPostLink url="https://youtu.be/TzdEpgONurw"/>,
- Traversy Media - <ExternalPostLink url="https://youtu.be/lziuNMk_8eQ" />.
...
Film na YT od Codeevolution o Typescript - <ExternalPostLink url="https://youtu.be/WBPrJSw7yQA"/>.
