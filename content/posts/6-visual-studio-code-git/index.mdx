...
Visual Studio Code to najpopularnijeszy edytor kodu na świecie. Ta teza pochodzi z ankiety przeprowadzonej na <ExternalPostLink name="Stack Overflow" url="https://insights.stackoverflow.com/survey/2018#technology-_-most-popular-development-environments"/>. VS Code jest darmowy, skonfigurowany z Git'em, łatwo rozszerzalny o dodatkowe wtyczki, utrzymywany przez Microsoft i stale aktualizowany.
...
<Image src="./vscode-soure-control.webp"/>
...
<Image src="./vscode-git-changes.webp"/>
...
<Image src="./vscode-cmd-hint.webp"/>
...
> Jak ustawić VS Code jako edytor oraz diff tool dowiesz się z <ExternalPostLink name="tego linku" url="https://blog.soltysiak.it/pl/2017/01/ustaw-visual-studio-code-jako-domyslny-edytor-oraz-diff-tool/"/>.
...
<Image src="./terminal-editor.webp"/>

... otworzy się nowa, piękna zakładka w VS Code:
<Image src="./vscode-editor.webp"/>
